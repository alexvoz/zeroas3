package com.dmotiko.opositor {
	...
	extends BaseClip {
		...
		private function btnBarChange(evnt):void {
			//OPSite.log( "OPBotonera btnBarChange= " + evnt.currentTarget);
			OPSite.getApp().setSection( navBar.getActiveButton().getData().section );			
		}
		...
		private function sectionChanged(e:Event):void {
			if ( !e || OPSite.getApp().getSection() == OPSite.HOME) {
